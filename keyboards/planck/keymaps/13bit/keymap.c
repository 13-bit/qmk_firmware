...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    TERM,          OSM(MOD_LCTL), OSM(MOD_LALT), OSM(MOD_LGUI), LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_DLR,  KC_PERC, KC_CIRC, _______, _______, _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
    _______, KC_AMPR, KC_ASTR, _______, _______, _______, _______, _______, _______, _______, KC_PIPE, _______,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_4,    KC_5,    KC_6,    KC_F4,   KC_F5,   KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, _______,
    _______, KC_7,    KC_8,    KC_9,    KC_0,    KC_F11,  KC_F12,  _______, _______, _______, KC_BSLS, _______,
